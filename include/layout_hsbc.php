...
<div id="container">
  ...
  <div id="instr_header">
    ...
    <table cellspacing=0 cellpadding=0 width=666 border=0>
      <TBODY><TR><TD class=ct width=666><div align=right><b class=cp>Recibo do Sacado</b></div></TD></tr></tbody>
    </table>
		<table class="header" border=0 cellspacing="0" cellpadding="0">
		<tbody>
		<tr>
			<td width=150><IMG SRC="<?php echo base64_img_encode('imagens/logohsbc.jpg'); ?>"></td>
			<td width=50>
